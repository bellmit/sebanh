...
// Layout
import {LayoutConfigService, MenuConfigService, MenuOptions, PageConfigService} from '../../../core/_base/layout';
...
export class BaseComponent implements OnInit, OnDestroy {
	...
	toggleChild() {
		this.commonService.isAsideRight$.next(!this.commonService.isAsideRight$.getValue());
	}

	// get isAsideRight() {
	// 	return this.commonService.isAsideRight$;
	// }
	//
	// get isDisplayAsideRight() {
	// 	return this.commonService.isDisplayAsideRight$;
	// }
