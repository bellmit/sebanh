...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		self: {
			...
			logo: {
				dark: './assets/media/logos/logo-seabank.png',
				light: './assets/media/logos/logo-seabank.png',
				brand: './assets/media/logos/logo-seabank.png',
				green: './assets/media/logos/logo-seabank.png',
			},
		},
		...
		loader: {
			enabled: true,
			type: 'spinner-logo',
			logo: './assets/media/logos/logo-SB.png',
			message: 'Please wait...',
		},
